...
const commonAmmoCategories = () => {
  const ret: { [k: string]: number[] } = {
    bow_t1: [
      882, 883, 5616, 5622, 598, 942, -3, // Bronze arrow + variants
      884, 885, 5617, 5623, 2532, 2533, -4, // Iron arrow + variants
  ...
  // Bows
  ret.bow_t5 = [...ret.bow_t1, 886, 887, 5618, 5624, 2534, 2535, -5]; // Steel arrow + variants
  ret.bow_t20 = [...ret.bow_t5, 888, 889, 5619, 5625, 2536, 2537, -6]; // Mithril arrow + variants
  ret.bow_t30 = [...ret.bow_t20, 890, 891, 5620, 5626, 2538, 2539, -7]; // Adamant arrow + variants
  ret.bow_t40 = [...ret.bow_t30, 892, 893, 5621, 5627, 78, 2540, 2541, -8]; // Rune arrow + variants, ice arrows
  ret.bow_t50 = [...ret.bow_t40, 21326, 21332, 21334, 21336, 4160, 21328, 21330, -9]; // Amethyst arrow + variants, broad arrows
  ret.bow_t60 = [...ret.bow_t50, 11212, 11227, 11228, 11229, 11217, 11222, -10]; // Dragon arrow + variants
